...
ML_SSECTORS, ML_NODES, ML_SECTORS, ML_BLOCKMAP};
...
// compmapsidedef has the texture names preconverted to texture indexes
// this is done as a final step, because if a texture is added all the
// maps will need to be resaved
typedef struct
{
	short		textureoffset;
	short		rowoffset;
...
#define ML_SECRETFOUND		512	// internal: the secret has been crossed
